...
_lr_productions = [
  ...
  ('program -> DECLARE declarations BEGIN commands END','program',5,'p_program','main.py',315),
  ('program -> BEGIN commands END','program',3,'p_program','main.py',316),
  ('declarations -> PID LBRACKET NUM COLON NUM RBRACKET','declarations',6,'p_declarations_array','main.py',322),
  ('declarations -> declarations COMMA PID LBRACKET NUM COLON NUM RBRACKET','declarations',8,'p_declarations_array','main.py',323),
  ('declarations -> PID','declarations',1,'p_declarations_pid','main.py',334),
  ('declarations -> declarations COMMA PID','declarations',3,'p_declarations_pid','main.py',335),
  ('commands -> command','commands',1,'p_commands','main.py',343),
  ('commands -> commands command','commands',2,'p_commands','main.py',344),
  ('command -> identifier ASSIGN expression SEMICOLON','command',4,'p_command_assign','main.py',373),
  ('command -> IF condition THEN commands ENDIF','command',5,'p_command_if','main.py',381),
  ('command -> IF condition THEN commands ELSE commands ENDIF','command',7,'p_command_if','main.py',382),
  ('command -> WHILE condition DO commands ENDWHILE','command',5,'p_command_while','main.py',386),
  ('command -> REPEAT commands UNTIL condition SEMICOLON','command',5,'p_command_repeat_until','main.py',390),
  ('iterator -> PID','iterator',1,'p_iterator','main.py',394),
  ('command -> FOR iterator FROM value TO value DO commands ENDFOR','command',9,'p_command_for','main.py',401),
  ('command -> FOR iterator FROM value DOWNTO value DO commands ENDFOR','command',9,'p_command_for','main.py',402),
  ('command -> READ identifier SEMICOLON','command',3,'p_command_io','main.py',410),
  ('command -> WRITE value SEMICOLON','command',3,'p_command_io','main.py',411),
  ('expression -> value','expression',1,'p_expression_value','main.py',419),
  ('expression -> value ADD value','expression',3,'p_operation','main.py',423),
  ('expression -> value SUB value','expression',3,'p_operation','main.py',424),
  ('expression -> value MUL value','expression',3,'p_operation','main.py',425),
  ('expression -> value DIV value','expression',3,'p_operation','main.py',426),
  ('expression -> value MOD value','expression',3,'p_operation','main.py',427),
  ('condition -> value EQUAL value','condition',3,'p_condition','main.py',433),
  ('condition -> value NOTEQUAL value','condition',3,'p_condition','main.py',434),
  ('condition -> value LOWER value','condition',3,'p_condition','main.py',435),
  ('condition -> value GREATER value','condition',3,'p_condition','main.py',436),
  ('condition -> value LOWEREQUAL value','condition',3,'p_condition','main.py',437),
  ('condition -> value GREATEREQUAL value','condition',3,'p_condition','main.py',438),
  ('value -> NUM','value',1,'p_value_NUM','main.py',444),
  ('value -> identifier','value',1,'p_value_identifier','main.py',448),
  ('identifier -> PID','identifier',1,'p_identifier_pid','main.py',452),
  ('identifier -> PID LBRACKET PID RBRACKET','identifier',4,'p_identifier_tab_id','main.py',460),
  ('identifier -> PID LBRACKET NUM RBRACKET','identifier',4,'p_identifier_tab_id','main.py',461),
]
